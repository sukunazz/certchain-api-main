...
interface OrganizerVerificationEmailProps {
  code: string;
  email: string;
}

const OrganizerVerificationEmail: FC<OrganizerVerificationEmailProps> = ({
  code,
  email,
}) => {
...
OrganizerVerificationEmail.PreviewProps = {
  code: '123456',
  platform: 'email',
  email: 'user@example.com',
};

export default OrganizerVerificationEmail;

...
const UserResetPasswordEmail: FC<UserResetPasswordEmailProps> = ({
  code,
  email,
}) => {
  const resetUrl = `${process.env.RESET_PASSWORD_URL}${code}`;
...
UserResetPasswordEmail.PreviewProps = {
  code: '123456',
  email: 'user@example.com',
};

export default UserResetPasswordEmail;
